...
from .energy import EnergyAnalyzer, EnergyReport
from .memory import MemoryEstimator, MemoryReport
from .concurrency import ConcurrencyAnalyzer
from graphs.core.structures import ConcurrencyDescriptor
...
class UnifiedAnalyzer:
    ...
    def _run_operator_edp_analysis(
        ...
        from .architecture_comparator import ArchitectureComparator
    ...
    def _create_hardware_mapper(
        ...
        hardware_map = {
            ...
            'jetson-thor-128gb': create_jetson_thor_128gb_mapper,
