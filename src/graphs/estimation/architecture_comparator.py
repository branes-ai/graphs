...
class ArchitectureComparator:
    ...
    def analyze_all(self):
        ...
        for arch_name, mapper in self.architectures.items():
            ...
            from .unified_analyzer import AnalysisConfig
    ...
    def get_operator_edp_breakdown(
        ...
        Example:
            ...
            ReLU: 0.01 nJ·s (2.5%)
        """
        from .architectural_modifiers import get_architectural_modifier, get_fusion_benefit
    ...
    def generate_operator_edp_report(
        ...
        Example Output:
            ...
            ...
        """
        from .architectural_modifiers import explain_modifier
