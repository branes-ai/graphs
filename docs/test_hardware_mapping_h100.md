# ResNet18: H100 GPU Hardware Mapping

This diagram shows how ResNet18 subgraphs map to H100 GPU resources.
...
**Insights**:
- Green: High utilization (>60%) - efficient use of SMs
- Yellow: Medium utilization (40-60%) - moderate efficiency
- Pink/Red: Low utilization (<40%) - underutilized hardware
- Red 'IDLE' box shows unused compute resources
