...
Available Dialects: acc, affine, amdgpu, amx, arith, arm_neon, arm_sme, arm_sve, async, bufferization, builtin, cf, complex, dlti, emitc, func, gpu, index, irdl, linalg, llvm, math, memref, mesh, ml_program, mpi, nvgpu, nvvm, omp, pdl, pdl_interp, polynomial, ptr, quant, rocdl, scf, shape, sparse_tensor, spirv, tensor, test, test_dyn, tosa, transform, ub, vector, x86vector, xegpu
  ...
  Compiler passes to run
    ...
    =debug-interface                                   -   Emit non-functional but easy-to-read interfaces to debug.
      ...
      --test-linalg-transform-patterns                       -   Test Linalg transformation patterns by applying them greedily.
        ...
        --test-decompose-tensor-pack                         - Test transform that generalizes pack ops into a sequence of tensor and Linalg ops
    ...
    =two                                               -   Example two value
      ...
      --test-vulkan-runner-pipeline                          -   Runs a series of passes for lowering GPU-dialect MLIR to SPIR-V-dialect MLIR intended for mlir-vulkan-runner.
