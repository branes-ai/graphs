...
- **Precision**: FP16
- **Thermal Profile**: 50W
- **Calibration Date**: 2026-02-06T01:27:56.705867
...
import json
with open('calibration_data/jetson_orin_agx_50w/fp16/efficiency_curves.json') as f:
    curves = json.load(f)

# Or copy to hardware_registry
cp calibration_data/jetson_orin_agx_50w/fp16/efficiency_curves.json \
   hardware_registry/cuda/jetson_orin_agx_50w/fp16/efficiency_curves.json
```
