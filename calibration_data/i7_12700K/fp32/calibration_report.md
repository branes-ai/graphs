# Calibration Report: Intel Core i7-12700K (Alder Lake)

## Hardware Configuration

- **Hardware ID**: i7-12700K
- **Device**: cpu
- **Thermal Profile**: None
- **Calibration Date**: 2026-02-04T18:48:13.429445
...
import json
with open('calibration_data/i7-12700K/efficiency_curves.json') as f:
    curves = json.load(f)

# Or copy to hardware_registry
cp calibration_data/i7-12700K/efficiency_curves.json \
