...
- **Calibration Date**: 2026-02-05T23:21:24.845675
...
import json
with open('calibration_data/jetson_orin_agx_maxn/fp32/efficiency_curves.json') as f:
    curves = json.load(f)

# Or copy to hardware_registry
cp calibration_data/jetson_orin_agx_maxn/fp32/efficiency_curves.json \
   hardware_registry/cuda/jetson_orin_agx_maxn/fp32/efficiency_curves.json
```
